...
if __name__ == "__main__":
    ...
    if args.model_name == 'EdgeBank':
        evaluate_edge_bank_link_prediction(args=args, train_data=train_data, val_data=val_data, test_data=test_data,
                                           val_idx_data_loader=val_idx_data_loader, test_idx_data_loader=test_idx_data_loader,
                                           evaluate_neg_edge_sampler=eval_neg_edge_sampler, eval_metric_name=eval_metric_name,
